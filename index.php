...
<head>
    ...
    <title>Viana Advocacia e Assesoria</title>
...
<body>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center justify-content-between no-gutters">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="index.php">
                                    <img src="./img/logo_small.png" alt="small_logo_Viana_Advocacia_e_Assesoria">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="#nav1">Áreas de Atuação</a></li>
                                        <li><a href="#nav2">Apresentação</a></li>
                                        <li><a href="#nav3">Contato</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
    ...
    <div class="slider_area">
        <img class="slider_area_logo" src="./img/logo_black.png" alt="large_logo_Viana_Advocacia_e_Assesoria">
    </div>
    <!-- slider_area_end -->

   
    <!-- practice_area_start -->
    <div id="nav1" class="practice_area">
        <div class="container-fluid p-0">
            <div class="row">
                <div class="col-xl-12">
            ...
            <div class="row no-gutters">
                            ...
                            <div class="hover_inner">
                                ...
                                <ul class="practice_list small">
                                    ...
                                    <li>
                                        ...
                                        <div id="modal1_practice" class="w3modal">
                                            <div class="w3modal_content">
                                                <span id="modalclose1_practice" class="w3modal_close">&times;</span>
                                                <a class="lern_more" href="./documents/estabelecimento_de_saude.pdf" target="blank">Estabelecimento de Saúde</a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="single_practice">
                        ...
                        <div class="practice_hover text-center">
                            <div class="hover_inner">
                                ...
                                <h3 class="practice_title">Trabalhista</h3>
                                <ul class="practice_list">
                                    <li>Direito individual do trabalho</li>
                                    <li>Direito coletivo do trabalho</li>
                                    <br>
                                    <li>
                                        <span id="btn2_practice" class="lern_more">Peças</span>
                                        <div id="modal2_practice" class="w3modal">
                                            <div class="w3modal_content">
                                                <span id="modalclose2_practice" class="w3modal_close">&times;</span>
                                                <a class="lern_more" href="./documents/engenheiro_x_construtora.pdf" target="blank">Engenheiro x Construtora</a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="single_practice">
                        ...
                        <div class="practice_hover text-center">
                            <div class="hover_inner">
                                ...
                                <h3 class="practice_title">Consumidor</h3>
                                <ul class="practice_list">
                                    <br>
                                    <li>
                                        <span id="btn3_practice" class="lern_more">Peças</span>
                                        <div id="modal3_practice" class="w3modal">
                                            <div class="w3modal_content">
                                                <span id="modalclose3_practice" class="w3modal_close">&times;</span>
                                                <a class="lern_more" href="./documents/consumidor_x_incorporadora.pdf" target="blank">Consumidor x Incorporadora</a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                ...
                <div class="col-xl-20 col-md-6">
                    <div class="single_practice">
                        <div class="practice_image">
                            <img src="img/practice/5.png" alt="">
                        </div>
                        <div class="practice_hover text-center">
                            <div class="hover_inner">
                                <i class="flaticon-courthouse"></i>
                    ...
                    <div class="single_practice">
                        ...
                        <div class="practice_hover text-center">
                            <div class="hover_inner">
                                ...
                                <h3 class="practice_title">Produção Acadêmica</h3>
                                <ul class="practice_list">
                                    <li><a class="lern_more" href="./documents/doutorado.pdf" target="blank">Tese de Doutorado</a></li>
                                    <li><a class="lern_more" href="./documents/mestrado.pdf" target="blank">Dissertação de Mestrado</a></li>
                                </ul>
                                <!-- <a href="#" class="lern_more">Learn More</a> -->
                            </div>
                        </div>
    ...
    <div id="nav3" class="appointment_area">
        <div class="container-fluid p-0">
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-60">
                    ...
                    <div class="col-xl-6 col-md-6 col-lg-6">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="index.php">
                                    <img src="./img/logo_mid.png" alt="mid_logo_Viana_Advocacia_e_Assesoria">
                                </a>
                            </div>
                        </div>
                    </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- JS here -->
    <script src="js/w3modal.js"></script>
